...
import { Contact, Stakeholder, StakeholderRole, CustomerType } from '../types';
...
export const ContactsView: React.FC = () => {
  ...
  // Gestione Tag (Cosa Comprano / Competitors)
  ...
  // Gestione Stakeholder (Contatti multipli)
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-indigo-50/50 dark:bg-indigo-900/10 p-6 rounded-3xl border border-indigo-50 dark:border-indigo-900/30">
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={e => setEditingContact({...editingContact, intelligence: {...(editingContact.intelligence||defaultIntelligence), pricesAndPayments: e.target.value}})}
                    />
                  </div>
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={e => setEditingContact({...editingContact, intelligence: {...(editingContact.intelligence||defaultIntelligence), logisticsAndService: e.target.value}})}
                    />
                  </div>
                </div>
              </section>

              {/* SEZIONE 4: NOTE GENERALI */}
              <section>
